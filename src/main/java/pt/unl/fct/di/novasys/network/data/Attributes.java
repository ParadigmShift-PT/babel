...
public class Attributes {
    ...
    public void putAll(Attributes attributes) {
        for (Map.Entry<String, byte[]> e : attributes.attrMap.entrySet()) {
            this.attrMap.put(e.getKey(), e.getValue());
        }
    }

    public void putAllCopy(Attributes attributes) {
        for (Map.Entry<String, byte[]> e : attributes.attrMap.entrySet()) {
            this.attrMap.put(e.getKey(), Arrays.copyOf(e.getValue(), e.getValue().length));
        }
    }
    ...
    public boolean containsKeys(String... keys) {
        return Arrays.stream(keys).allMatch(k -> attrMap.containsKey(k));
    }
