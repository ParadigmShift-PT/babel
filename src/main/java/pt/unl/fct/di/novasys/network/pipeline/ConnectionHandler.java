...
public abstract class ConnectionHandler<T> extends ChannelDuplexHandler implements Connection<T> {
    ...
    public ConnectionHandler(long connectionId, MessageListener<T> consumer, EventLoop loop,
            boolean incoming, Attributes selfAttrs) {
    ...
    protected abstract void internalUserEventTriggered(ChannelHandlerContext ctx, Object evt);
